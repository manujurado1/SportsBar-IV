...
Finalmente, decidí optar por Go, ya que a parte de ser uno de los lenguajes que tenía intención de aprender en un futuro, tiene ciertas
...
La misma pagina oficial te da un abanico de posibilidades para
...
\item
  ...
  manujurado1 marked this conversation as resolved.
\end{itemize}
...
\item
  ...
  acerca de la forma de testear nativa de Go, la cuál no incluye
...
optará por usar Testify como bibioteca de aserciones. Se puede acceder a
...
tiene un test runner propio, el cuál hace que sea muy sencillo lanzar y
gestionar los tests. Además, no se ha encontrado ninguna alternativa
real que ofrezca algún motivo por el que usarla en vez del test runner
nativo de Go.
...
\item
  ...
  necesidades. (Evitar imagenes que incluyan paquetes o funcionalidades
...
Tras ver las \href{https://hub.docker.com/_/golang}{imagenes oficiales}
...
\item
  ...
  Su última versión es para Go 1.17, lo que lo hace tambien estar peor
...
\item
  ...
  lo que lo hace tambien estar peor posicionado que las oficiales
  elegidas. Su ultima actualización fue hace 15 días, por lo que cumple
...
\item
  ...
  que la imagen de alpine oficial, la cuál, pese a ambas estar en
...
\item
  ...
  frescura ya que su ultima actualización fue hace 3 días.
\end{itemize}
...
que siguen teniendo soporte} y en base a esta información se han
