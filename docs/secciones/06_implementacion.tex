...
\item
  No proporciona ayuda frente validación de solicitudes ni manejo de errores, habría que tratarlos manualmente.
\item
...
otros frameworks, aporta facilidades en la validación de solicitudes y manejo de errores respecto a net/http (biblioteca estandar de Go) y no es una opción muy pesada que vaya a producir un 
